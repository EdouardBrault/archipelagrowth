...
// Shared page routes used for both EN (no prefix) and IT (/it prefix)
const PageRoutes = () => (
  <>
...
const AppRoutes = () => (
  <LanguageProvider>
    ...
    <Routes>
      ...
      <Route path="/it/geo-services" element={<ArchipelService />} />
      <Route path="/it/google-ads" element={<ArchipelServiceGeneric serviceKey="google-ads" />} />
      <Route path="/it/linkedin-ads" element={<ArchipelServiceGeneric serviceKey="linkedin-ads" />} />
      <Route path="/it/meta-ads" element={<ArchipelServiceGeneric serviceKey="meta-ads" />} />
      <Route path="/it/seo-services" element={<ArchipelServiceGeneric serviceKey="seo" />} />
      <Route path="/it/landing-pages" element={<ArchipelServiceGeneric serviceKey="landing-page" />} />
      <Route path="/it/geo-audit" element={<SimulateurAuditGeo />} />
      <Route path="/it/contact" element={<ArchipelContact />} />
      <Route path="/it/about" element={<ArchipelAPropos />} />
      <Route path="/it/references" element={<ArchipelNosReferences />} />
      <Route path="/it/blog" element={<ArchipelBlog />} />
      <Route path="/it/blog/:slug" element={<ArchipelArticleDetail />} />
