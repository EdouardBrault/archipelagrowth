  ...
  const proofs = [
    {
      ...
      description: "Methodology based on real data from ChatGPT, Mistral, Perplexity, Deepseek…",
      imagePlaceholder: "/lovable-uploads/86e96713-6242-4a67-856d-e30b9339d825.png"
    },
    {
      number: "0 BACKLINKS",
      subtitle: "needed to perform",
      description: "AI relies on clarity, structure, and relevance — not domain authority",
      imagePlaceholder: "/lovable-uploads/e776fb76-7ac9-4177-ae42-f6bf1449edda.png"
    },
    {
      number: "3 DAYS",
      subtitle: "to see results",
      description: "Visibility activated ultra-fast, without backlinks or lengthy content production",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
            <span className="text-archipel-cyan">AI Optimization</span> : #1 on ChatGPT in 3 days
          </h2>
          <p className="text-lg text-gray-300 leading-relaxed max-w-5xl mx-auto">
            Our revolutionary <strong className="text-archipel-cyan">GEO</strong> methodology enables <span className="text-archipel-cyan">AI engines</span> to recommend your company <br className="hidden md:block" />
            instantly. The leading <strong>GEO agency</strong> in the US masters complete <strong>AI Optimization</strong>.
          </p>
        </div>
          ...
          <div className="relative group">
            ...
            <div className="relative transform group-hover:scale-105 transition-transform duration-500">
              <img 
                ...
                alt="GEO Dashboard - AI Engine Visibility" 
