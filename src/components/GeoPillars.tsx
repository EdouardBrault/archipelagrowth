...
const pillars = [
  {
    ...
    link: "/geo-services#audit-visibilite",
  },
  {
    ...
    link: "/geo-services#publication-contenu",
  },
  {
    ...
    link: "/geo-services#identification-sources",
  },
];
    ...
    <section className="py-20 bg-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-lg text-[#010D3E] mb-8 max-w-2xl mx-auto leading-relaxed font-inter">
          At ArchipelaGrowth, we've identified 3 key areas to work on for a significant impact on brand visibility across LLMs.
        </p>
        ...
        <div className="flex justify-center mb-14">
          ...
          >
            <Link to="/contact#contact-form">Your GEO Score</Link>
          </Button>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {pillars.map((pillar) => (
            ...
            >
              <div className="mb-8">
                <img src={pillar.icon} alt={pillar.title} className="w-16 h-16 object-contain" />
              </div>
