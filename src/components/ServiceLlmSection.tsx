      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <h2 className="font-jakarta text-4xl md:text-5xl font-bold mb-6 leading-tight">
          <span className="bg-gradient-to-r from-[#000000] to-[#001354] bg-clip-text text-transparent">
            Nous influençons votre visibilité sur les LLMs suivants
          </span>
        </h2>
          ...
          <div className="flex flex-col items-center gap-6">
            ...
            <div className="flex justify-center">
              <img
                src={aiLogos[0].src}
                alt={aiLogos[0].alt}
                className="h-28 md:h-48 w-auto object-contain transition-all duration-700 ease-out"
                style={{
                  opacity: visibleLogos.includes(0) ? 1 : 0,
                  transform: visibleLogos.includes(0) ? 'scale(1) translateY(0)' : 'scale(0.5) translateY(20px)',
                }}
                loading="lazy"
              />
            </div>
            {/* Row 2 - Google AI + Copilot */}
            <div className="flex items-center justify-center gap-12 md:gap-20">
              {[1, 2].map((i) => (
                <img
                  ...
                  src={aiLogos[i].src}
                  alt={aiLogos[i].alt}
                  className="h-24 md:h-40 w-auto object-contain transition-all duration-700 ease-out"
                  style={{
                    opacity: visibleLogos.includes(i) ? 1 : 0,
                    transform: visibleLogos.includes(i) ? 'scale(1) translateY(0)' : 'scale(0.5) translateY(20px)',
                  }}
                  loading="lazy"
                />
              ))}
            ...
            <div className="flex justify-center">
              <img
                ...
                className="h-24 md:h-40 w-auto object-contain transition-all duration-700 ease-out"
                style={{
                  opacity: visibleLogos.includes(3) ? 1 : 0,
                  transform: visibleLogos.includes(3) ? 'scale(1) translateY(0)' : 'scale(0.5) translateY(20px)',
                }}
                loading="lazy"
              />
            </div>
            {/* Row 4 - DeepSeek + Perplexity */}
            <div className="flex items-center justify-center gap-12 md:gap-20">
              <img
                src={aiLogos[4].src}
                alt={aiLogos[4].alt}
                className="h-24 md:h-40 w-auto object-contain transition-all duration-700 ease-out"
                style={{
                  opacity: visibleLogos.includes(4) ? 1 : 0,
                  transform: visibleLogos.includes(4) ? 'scale(1) translateY(0)' : 'scale(0.5) translateY(20px)',
              ...
              <img
                ...
                className="h-24 md:h-40 w-auto object-contain transition-all duration-700 ease-out"
                style={{
                  opacity: visibleLogos.includes(5) ? 1 : 0,
                  transform: visibleLogos.includes(5) ? 'scale(1) translateY(0)' : 'scale(0.5) translateY(20px)',
                }}
                loading="lazy"
              />
            </div>
            ...
            <div className="flex justify-center">
              <img
                ...
                className="h-24 md:h-40 w-auto object-contain transition-all duration-700 ease-out"
                style={{
                  opacity: visibleLogos.includes(6) ? 1 : 0,
                  transform: visibleLogos.includes(6) ? 'scale(1) translateY(0)' : 'scale(0.5) translateY(20px)',
                }}
                loading="lazy"
              />
            </div>
